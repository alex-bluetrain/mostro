...
const SUBSCRIBERS_PATH = resolve(process.cwd(), 'meds-subscribers.json')

async function readSubscribersFile(): Promise<MedsSubscriber[]> {
    try {
...
async function writeSubscribersFile(subscribers: MedsSubscriber[]): Promise<void> {
