...
- If the user wants to order diapers, use requestDiapersTool with the diaper type and quantity. If a request is already in progress, tell them so instead of starting a new one.
