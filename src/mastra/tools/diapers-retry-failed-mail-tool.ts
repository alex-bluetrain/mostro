...
export const retryDiapersFailedMailTool = createTool({
    ...
    execute: async (_input, context) => {
        ...
        const result = await retryFailedMails(appConfig.DIAPERS_EMAIL_TO)
