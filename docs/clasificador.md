  ...
  "outcomes": [
    {
      ...
      "examples": {
        "match": [
          "confirmo pedido con fecha de entrega el día:  JUEVES 16-04 Consta de: 12 PLENITUD PROTECT G X 16 Dirección de entrega:  MAIPU 1234  - CABA  - BUENOS AIRES código de pedido: 0001-00103210"
        ],
        "no_match": [
      ...
      "extract": {
        ...
        "properties": {
          ...
          "orderNumber": {
            "type": "string",
            "description": "Número o Código de pedido (ej: 0001-00441234)"
          }
        },
        "required": [
          "deliveryDate",
